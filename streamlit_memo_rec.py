...
def main():   
    ...
    if dispositivo == "Computer":
        ...
        if st.session_state.transcription != "":
            ...
            st.warning("La **modifica** della trascrizione da smartphone potrebbe essere più difficoltosa che da computer, per potervi muovere lungo il testo utilizzare le **frecce direzionali** virtuali (ad esempio sulla tastiera Samsung: selezionando la modalità 'Modifica Testo' nelle 'Impostazioni' [...] in alto a destra della tastiera virtuale).")
