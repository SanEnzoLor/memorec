...
def main():   
    ...
    st.write(f"I dati raccolti, in formato solamente testuale e anonimo (la traccia vocale, se utilizzata, verrà cancellata una volta trascritta), saranno caricati su una banca dati privata di GitHub: {st.markdown("https://github.com/SanEnzoLor/memo_data")}.  Tuttavia, Streamlit Cloud potrebbe raccogliere dati anonimi sull'utilizzo dell'app per scopi di analisi. Per ulteriori informazioni, consulta {st.markdown("https://streamlit.io/privacy-policy")}.")
