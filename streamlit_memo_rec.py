...
def BDI2(value):
    ...
    items = items + options.index(st.selectbox("Pessimismo", options, on_change = BDI2_on_change(value)))
    ...
    items = items + options.index(st.selectbox("Fallimento", options, on_change = BDI2_on_change(value)))
